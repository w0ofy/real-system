const textColors = {
  ...
  'color-text-brand': 'rgb(99,91,255)',
  'color-text-brand-inverse': 'rgb(255, 255, 255)',
  'color-text-brand-muted': 'rgb(174, 178, 193)',

  'color-text-success': 'rgb(14, 124, 58)',
  'color-text-success-strong': 'rgb(15, 101, 63)',
  'color-text-success-weakest': 'rgb(237, 253, 243)',
  'color-text-success-muted': 'rgb(237, 253, 243)',

  'color-text-danger': 'rgb(214, 31, 31)',
  'color-text-danger-strong': 'rgb(117, 12, 12)',
  'color-text-danger-weak': 'rgb(246, 177, 177)',
  'color-text-danger-muted': 'rgb(246, 177, 177)',
