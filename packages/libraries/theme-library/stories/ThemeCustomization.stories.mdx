...
It should be easier to have greater impact. The lesser the impact, the more difficult things get.
...
By simply changing 1 or 2 colors, you impact many components throughout the system. But,
this doesn't give you granular (or "atomic") control over component's look & feel.
You can **override** an existing palette or **create** your own palette.

#### Low Level ([themes and tokens](/docs/real-system-theming-theme-customization--page#theme--token-customization))

Creating or extending a `theme` follows a different philosophy: medium effort, low return.
At first that sounds odd — but this API layer is meant to grant you the granular control
over component's look & feel that a `palette` can't. If you want to change 1 color within a component,
you can — but this requires knowledge of the inner-workings of the theme object (tokens).
...
// THEN: pass the customized theme to ThemeProvider
...
// FINALLY: pass your theme to ThemeProvider
