...
#### Low Level ([palettes](/docs/real-system-theming-theme-customization--page#palette-customization))
...
#### High Level ([themes and tokens](/docs/real-system-theming-theme-customization--page#theme--token-customization))

Creating or extending a `theme` follows a different philosophy: low effort, low return.
At first that sounds odd — but this API layer is meant to grant you the granular control
over component's look & feel that a `palette` can't. If you want to change 1 color
